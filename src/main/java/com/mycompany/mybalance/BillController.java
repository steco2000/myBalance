...
public class BillController {
    ...
    public static double amountMem;
    ...
    public static double eventualTransferAmount;

    public BillController(Stage primaryStage){
    ...
    //TODO : COLLEGA DB
    public static void manageCreateBill(TextField amountField, TextField descField, ChoiceBox<String> fromBillSelectionMenu) {
        boolean check = false;
    ...
    public static boolean isDoubleTransfer(TextField input) {
        String message = input.getText();
        try{
            double amount = Double.parseDouble(message);
            message = message.replace(",",".");
    ...
    public static BillEntity searchBill(String toSearch){
        int n = BillController.totalBills;
        ...
        for(int i=0; i<n; i++){
            ...
            if(Objects.equals(BillController.billArray[i].name, toSearch)){
                return BillController.billArray[i];
            }
        }
        return null;
    }

    public static void transferFunds(ChoiceBox<String> fromMenu, ChoiceBox<String> targetMenu, TextField amountField, Scene father) {
